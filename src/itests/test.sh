...
# Get sqk's peers.
sleep 1
# ./sqk_ctl.exp "sqk" "getpeers"
get_peers_output=$(./sqk_ctl.exp "sqk" "getpeers")
echo "get_peers_output"
echo $get_peers_output

# Get alice's wallet balance.
sleep 1
# ./sqk_ctl.exp "sqk_alice" "get_wallet_balance"
get_wallet_balance_output=$(./sqk_ctl.exp "sqk" "getwalletbalance")
